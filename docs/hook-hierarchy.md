...
└─ RevertHookAccess
   └─ RevertHookState
      └─ RevertHookSwapActions   (fourth delegatecall target; shares the spine only up to RevertHookState)
```
