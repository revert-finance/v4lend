...
/// @notice Base class containing all configuration-related functions for RevertHook
/// @dev Inherits state from RevertHookState and handles position configuration management
abstract contract RevertHookConfig is RevertHookState {
