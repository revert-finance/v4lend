...
import {V4TestBase} from "test/vault/support/V4TestBase.sol";
...
contract V4ForkTestBase is V4TestBase {
    ...
    function setUp() public virtual override {
        ...
        v4Utils = new V4Utils(positionManager, address(swapRouter), EX0x, permit2);

        // Deploy V4Oracle with the real deployed contracts
        v4Oracle = new V4Oracle(positionManager, address(USDC_ADDRESS), 0x000000000000000000000000000000000000dEaD);
    ...
    function _createSwapData(
        ...
        inputs[0] = abi.encode(
            recipient, amountIn, amountOutMin, abi.encodePacked(address(tokenIn), uint24(500), address(tokenOut)), false
        );
